...
public class BeetrootFarmerContainer extends Container {
    ...
    public BeetrootFarmerContainer(int id, PlayerInventory playerInventory, PacketBuffer buffer) {
        this(id, playerInventory, new BeetrootFarmerTileEntity(), new IntArray(buffer.readByte()));
    }

    public BeetrootFarmerContainer(int id , PlayerInventory playerInventory, IInventory inventory, IIntArray fields) {
        super(ModContainers.BEETROOT_FARMER.get(), id);
