...
public class PotatoFarmerContainer extends Container {
    private final IInventory inventory;
    private IIntArray fields;

    public PotatoFarmerContainer(int id, PlayerInventory playerInventory, PacketBuffer buffer) {
        this(id, playerInventory, new PotatoFarmerTileEntity(), new IntArray(buffer.readByte()));
    }

    public PotatoFarmerContainer(int id , PlayerInventory playerInventory, IInventory inventory, IIntArray fields) {
        super(ModContainers.POTATO_FARMER.get(), id);
