...
public class PumpkinFarmerContainer extends Container {
    private final IInventory inventory;
    private IIntArray fields;

    public PumpkinFarmerContainer(int id, PlayerInventory playerInventory, PacketBuffer buffer) {
        this(id, playerInventory, new PumpkinFarmerTileEntity(), new IntArray(buffer.readByte()));
    }

    public PumpkinFarmerContainer(int id , PlayerInventory playerInventory, IInventory inventory, IIntArray fields) {
        super(ModContainers.PUMPKIN_FARMER.get(), id);
