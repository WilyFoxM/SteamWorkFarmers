...
public class MelonFarmerContainer extends Container {
    private final IInventory inventory;
    private IIntArray fields;

    public MelonFarmerContainer(int id, PlayerInventory playerInventory, PacketBuffer buffer) {
        this(id, playerInventory, new MelonFarmerTileEntity(), new IntArray(buffer.readByte()));
    }

    public MelonFarmerContainer(int id , PlayerInventory playerInventory, IInventory inventory, IIntArray fields) {
        super(ModContainers.MELON_FARMER.get(), id);
