...
public class WheatFarmerTileEntity extends LockableTileEntity implements ISidedInventory, ITickableTileEntity {
    ...
    public WheatFarmerTileEntity() {
        super(ModTileEntityTypes.WHEAT_FARMER.get());
    ...
    protected ITextComponent getDefaultName() {
        return new TranslationTextComponent("container.steamworks.wheat_farmer");
    }

    @Override
    protected Container createMenu(int id, PlayerInventory playerInventory) {
        return new WheatFarmerContainer(id, playerInventory, this, this.fields);
    }
