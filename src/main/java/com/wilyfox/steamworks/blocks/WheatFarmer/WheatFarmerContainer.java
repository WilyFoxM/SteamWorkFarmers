...
public class WheatFarmerContainer extends Container {
    private final IInventory inventory;
    private IIntArray fields;

    public WheatFarmerContainer(int id, PlayerInventory playerInventory, PacketBuffer buffer) {
        this(id, playerInventory, new WheatFarmerTileEntity(), new IntArray(buffer.readByte()));
    }

    public WheatFarmerContainer(int id , PlayerInventory playerInventory, IInventory inventory, IIntArray fields) {
        super(ModContainers.WHEAT_FARMER.get(), id);
