...
public class ShugarcaneFarmerScreen extends ContainerScreen<ShugarcaneFarmerContainer> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(SteamWorks.MODID, "textures/gui/shugarcane_farmer.png");

    public ShugarcaneFarmerScreen(ShugarcaneFarmerContainer container, PlayerInventory playerInventory, ITextComponent title) {
