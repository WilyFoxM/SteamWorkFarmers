...
public class ShugarcaneFarmerContainer extends Container {
    private final IInventory inventory;
    private IIntArray fields;

    public ShugarcaneFarmerContainer(int id, PlayerInventory playerInventory, PacketBuffer buffer) {
        this(id, playerInventory, new ShugarcaneFarmerTileEntity(), new IntArray(buffer.readByte()));
    }

    public ShugarcaneFarmerContainer(int id , PlayerInventory playerInventory, IInventory inventory, IIntArray fields) {
        super(ModContainers.SHUGARCANE_FARMER.get(), id);
