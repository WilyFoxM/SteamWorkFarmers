...
public class CactusFarmerContainer extends Container {
    private final IInventory inventory;
    private IIntArray fields;

    public CactusFarmerContainer(int id, PlayerInventory playerInventory, PacketBuffer buffer) {
        this(id, playerInventory, new CactusFarmerTileEntity(), new IntArray(buffer.readByte()));
    }

    public CactusFarmerContainer(int id , PlayerInventory playerInventory, IInventory inventory, IIntArray fields) {
        super(ModContainers.CACTUS_FARMER.get(), id);
